...
class TestConfigDataclass:
    ...
    def test_ignored_dirs_independent_copies(self):
...
class TestGetConfigPath:
    """Tests for platform-specific config path"""
    ...
    def test_path_ends_with_config_toml(self):
        """Config path should end with ghlang/config.toml"""
        path = get_config_path()
        assert path.name == "config.toml"
        assert path.parent.name == "ghlang"


class TestLoadConfig:
    """Tests for config file loading"""

    def test_load_valid_config(self, tmp_config: Path, valid_config_content: str):
    ...
    def test_load_minimal_config(self, tmp_config: Path, minimal_config_content: str):
    ...
    def test_missing_token_raises_error(self, tmp_config: Path):
    ...
    def test_placeholder_token_raises_error(self, tmp_config: Path):
    ...
    def test_missing_token_allowed_when_not_required(self, tmp_config: Path):
    ...
    def test_invalid_toml_raises_config_error(self, tmp_config: Path):
    ...
    def test_cli_overrides_applied(self, tmp_config: Path, minimal_config_content: str):
    ...
    def test_cli_overrides_none_values_ignored(self, tmp_config: Path, valid_config_content: str):
